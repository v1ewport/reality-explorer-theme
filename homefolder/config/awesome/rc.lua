...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "s", function() awful.util.spawn("screenshot") end),
    awful.key({ modkey,           }, "b", function() awful.util.spawn("opera") end),
    awful.key({ modkey,           }, "e", function() awful.util.spawn("pcmanfm") end),
    awful.key({ modkey,           }, "d", function() awful.util.spawn("rofi -theme solarized -show drun") end),
    awful.key({ modkey,           }, "s", function() awful.util.spawn("rofi -theme solarized -show window") end),
    awful.key({ modkey,           }, "k",
        function ()
            awful.client.focus.byidx(-1)
        end,
